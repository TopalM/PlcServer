...
export default function makeAuxiliaryFacilitiesDataModel(plcConn) {
  const s = new mongoose.Schema(
    ...
    { collection: "auxiliaryFacilitiesData", timestamps: false, versionKey: false, strict: true, minimize: true }
  );
  ...
  return plcConn.models.AuxiliaryFacilitiesData || plcConn.model("AuxiliaryFacilitiesData", s, "auxiliaryFacilitiesData");
}
