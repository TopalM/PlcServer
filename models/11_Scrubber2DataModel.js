...
export default function makeScrubber2DataModel(plcConn) {
  const scrubber2DataSchema = new mongoose.Schema(
    {
  ...
  return plcConn.models.Scrubber2Data || plcConn.model("Scrubber2Data", scrubber2DataSchema, "scrubber2Data");
}
